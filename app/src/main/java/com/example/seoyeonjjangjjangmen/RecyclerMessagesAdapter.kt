...
import com.example.seoyeonjjangjjangmen.databinding.MessageMineBinding
import com.example.seoyeonjjangjjangmen.databinding.MessageOtherBinding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.FirebaseDatabase
import com.google.firebase.database.ValueEventListener
//import com.google.firebase.database.core.Context // content.Context or database.core.Context
...
class RecyclerMessagesAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            1 -> {            //메시지가 내 메시지인 경우
                ...
                val view =
                    LayoutInflater.from(context)
                        .inflate(R.layout.message_other, parent, false)  //상대 메시지 레이아웃으로 초기화
                OtherMessageViewHolder(MessageOtherBinding.bind(view))
            }
        }
    }
    ...
    inner class OtherMessageViewHolder(itemView: MessageOtherBinding) :         //상대 메시지 뷰홀더
